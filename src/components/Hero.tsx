                ...
                <div className="grid lg:grid-cols-[1.2fr_0.8fr] items-start">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="inline-flex items-center gap-2 bg-purple-600/20 border border-purple-500/30 rounded-full px-4 py-2">
                            ...
                            <span className="text-gray-300 text-sm">Registrations are now open!</span>
                        </div>
                        ...
                        <div className="flex items-center gap-6 pt-2">
                            ...
                            <div className="flex items-center gap-2 text-gray-300">
                                ...
                                <span className="font-medium text-sm">HANDS-ON</span>
                            </div>
                            <div className="flex items-center gap-2 text-gray-300">
                    ...
                    <div className="relative lg:mt-8">
                        <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">
                            <div className="text-center mb-5">
                                <h3 className="text-xl font-bold text-white mb-1">Book a Free Call</h3>
                                <p className="text-gray-400 text-sm">Let's discuss how this course can help you achieve your design goals</p>
                            </div>
                            ...
                            <form className="space-y-3">
                                ...
                                <div>
                                    <label htmlFor="experience" className="block text-xs font-medium text-gray-300 mb-1">
                                        Design Experience
                                    </label>
                                    <select
                                        id="experience"
                                ...
                                <div>
                                    <label htmlFor="goals" className="block text-xs font-medium text-gray-300 mb-1">
                                        Your Goals
                                    </label>
                                    <textarea
                                        id="goals"
